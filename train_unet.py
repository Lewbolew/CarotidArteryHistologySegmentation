...
def train(model, train_loader, val_loader, optimizer, num_epochs, path_to_save_best_weights):
    ...
    writer = SummaryWriter('runs/attention_r2_unet/')
    ...
    torch.save(best_model_weights, 
        os.path.join(path_to_save_best_weights, 'attention_r2_unet{:2f}.pth'.format(best_val_loss)))
...
#                 (0,255,255), (128,130,128), (190,190,128)  
#                )
mask_values = (
                0,1,2,
                3,4,5,
